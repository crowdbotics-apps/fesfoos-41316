"""
Django settings for fesfoos_41316 project.
...
ROOT_URLCONF = 'fesfoos_41316.urls'
...
WSGI_APPLICATION = 'fesfoos_41316.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fesfoos_41316 API",
    "DESCRIPTION": "API documentation for fesfoos_41316 App",
    "VERSION": "v1",
}
